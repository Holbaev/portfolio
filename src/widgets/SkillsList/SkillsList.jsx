          ...
          <div className={styles.content_wrapper}>
            ...
            <div className={styles.content}>
              <div className={styles.experience_text}>
                ...
                <p className={styles.content_title}>company - Preeinterview</p>
                <p className={styles.content_date}>01.2022 - 03.2023</p>
                <p className={styles.content_desk}>
                  In this company we developed the Preeinterview project. This
                  project was a startup. He himself prepared questions and tasks
                  using artificial intelligence, or as people call it (Open ai).
                  As the project itself says, its main task was to prepare for
                  the interview. Its audience was aimed at QA and Devops
                  developers.
                </p>
              </div>
              <div className={styles.experience_text}>
                ...
                <p className={styles.content_desk}>
                  ...
                  for universities. At first i developed an excellent
                  microservice for evaluating the work of university employees.
                  I also developed an microservice “RUP”, which made it possible
                  to create a schedule for students in the form of a document.
                </p>
              </div>
              <div className={styles.experience_text}>
                <p className={styles.content_pos}>Frontend Developer</p>
                <p className={styles.content_title}>company - Web Dev</p>
                <p className={styles.content_date}>09.2022 - 01.2023</p>
                <p className={styles.content_desk}>
                  I was a junior developer in this company. Here I developed
                  English language courses website. This project is important to
                  myself as registration and payment. I have also developed
                  different filters so that people can choose the course
